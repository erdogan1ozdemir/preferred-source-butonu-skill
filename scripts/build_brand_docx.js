...
const kids = [
  ...
  RICH([{t:"Raporlamada tıklama net sayı olarak paylaşılır. Ekleme sayısı paylaşılmaz; doğru ifade "},
        {t:"\"kaç okuyucu butona tıkladı\"", b:true}, {t:" biçimindedir."}]),
  P("Google'ın kendi gömme butonu da bir seçenektir; bu yöntem, butonun okuyucunun diline göre otomatik çevrilmesini sağlar. Ancak o buton sayfaya ayrı bir çerçeve içinde yerleştiğinden tıklaması ölçülememektedir. Ölçülebilirlik tercih edildiği için yayıncı bağlantısı kullanılmaktadır.", {after:60}),
  SRCL("Kaynak: ", [["Google Search Central · Preferred Sources yayıncı dokümantasyonu", L_DEV]]),
